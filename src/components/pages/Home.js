    ...
    return (
        <div className='home-page'>
            <div class="Intro">
                ...
                <p>
                    I am a highly skilled Full Stack Web Developer with a diverse background in the strategy and operations consulting industry Leveraging my combined expertise in web development and strategic problem-solving, I consistently deliver exceptional results that drive business success.

                    Throughout my career, I have developed a strong proficiency in creating dynamic and user-friendly web applications. With expertise in front-end technologies such as React, HTML, and CSS, as well as back-end frameworks like Javascript, Node.js, Express.js, and MongoDB, I possess a comprehensive understanding of the complete web development stack.
                </p>
                <p>
                ...
                <p>
                    I believe my diverse background, ranging from consulting to sports and entrepreneurship, provides me with a unique perspective and skillset for any endeavor. Whether it's coding, advancing in business, or pursuing my interests, I'm excited about the experiences that lie ahead.
